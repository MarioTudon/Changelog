        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 pt-4 rounded-lg shadow-lg w-1/5 min-w-52 relative flex flex-col">
                ...
                <div className='flex flex-col mt-auto'>
                    <input className='border-slate-900 w-full h-9 px-4 border-2 rounded-lg' type="text" name="modal-text-input" id="modal-text-input" maxLength={'80'} placeholder="Enter your log here" ref={inputRef} onChange={handleChange} onKeyDown={handleEnterKey}/>
